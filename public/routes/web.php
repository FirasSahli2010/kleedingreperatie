<?php
namespace App\Public\routes;

use App\Public\Src\Controllers\PageController;
use App\Public\Src\Routes\Router;
...
$router->addRoute('GET', '/{lang}/aboutus', [PageController::class, 'about']);
